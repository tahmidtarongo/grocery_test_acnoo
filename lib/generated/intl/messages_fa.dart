...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "allBusinessSolutions": MessageLookupByLibrary.simpleMessage("تمامی راه‌حل‌های تجاری"),
        "allBusinessolutionDescrip": MessageLookupByLibrary.simpleMessage("فروش پرو، یک راه‌حل کامل تجاری با مدیریت موجودی، حسابداری، فروش، هزینه و زیان/سود می‌باشد."),
        "alreadyAdded": MessageLookupByLibrary.simpleMessage("قبلا اضافه شده"),
        "amount": MessageLookupByLibrary.simpleMessage("میزان"),
        "anewUpdateAvailable": MessageLookupByLibrary.simpleMessage("بروزرسانی جدید موجود است\nلطفاً نرم‌افزار خود را بروز کنید"),
        ...
        "choseyourfeatureDesciption":
            MessageLookupByLibrary.simpleMessage("ویژگی‌ها بخش مهمی از کاربرد اپلیکیشن فروش حرفه‌ای را تشکیل می‌دهند که آن را از راه‌حل‌های سنتی متمایز می‌کنند."),
        ...
        "dailyTransaction": MessageLookupByLibrary.simpleMessage("تراکنش‌های روزانه"),
        ...
        "easyToUseThePos": MessageLookupByLibrary.simpleMessage("پرداخت آسان با موبایل"),
        "easytheusedesciption":
            MessageLookupByLibrary.simpleMessage("اپلیکیشن فروش حرفه‌ای رایگان و آسان در استفاده است. در واقع، این یکی از بهترین سیستم‌های نقطه‌فروش در سراسر دنیاست."),
        ...
        "enterRefNumber": MessageLookupByLibrary.simpleMessage("شماره مرجع را وارد کنید"),
        ...
        "noDataAvailabe": MessageLookupByLibrary.simpleMessage("اطلاعاتی موجود نیست"),
        "noRoleFound": MessageLookupByLibrary.simpleMessage("هیچ نقش کاربری یافت نشد"),
        ...
        "pleaseConnectThePrinterFirst": MessageLookupByLibrary.simpleMessage("لطفاً ابتدا پرینتر را متصل کنید"),
        "pleaseEnterAConfirmPassword": MessageLookupByLibrary.simpleMessage("لطفاً رمز عبور تأییدیه را وارد کنید"),
        "pleaseEnterAPassword": MessageLookupByLibrary.simpleMessage("لطفاً یک رمز عبور وارد کنید"),
        "powerdedByAcnoo": MessageLookupByLibrary.simpleMessage("توسط اکنو پشتیبانی می‌شود"),
        ...
        "rememberMeLater": MessageLookupByLibrary.simpleMessage("بعداً به من یادآوری کن"),
        ...
        "seeAllPromoCode": MessageLookupByLibrary.simpleMessage("مشاهده همه کدهای تخفیف"),
        ...
        "socialMarketing": MessageLookupByLibrary.simpleMessage("بازاریابی اجتماعی"),
        ...
        "thakYouForYourPurchase": MessageLookupByLibrary.simpleMessage("از خرید شما متشکریم"),
        "thankYouForYourDuePayment": MessageLookupByLibrary.simpleMessage("از پرداخت مستحق شما متشکریم"),
        ...
        "writeYourMessageHere": MessageLookupByLibrary.simpleMessage("پیام خود را اینجا بنویسید"),
        ...
        "yourPackageExpiredInDays": MessageLookupByLibrary.simpleMessage("پکیج شما تا 5 روز دیگر منقضی خواهد شد"),
        "yourPackageExpiredToday": MessageLookupByLibrary.simpleMessage("پکیج شما امروز منقضی خواهد شد\n\nلطفاً دوباره خرید کنید")
      };
}
