...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "allBusinessolutionDescrip": MessageLookupByLibrary.simpleMessage(
            "DoSofto هو حلاً شاملاً للأعمال مع الأسهم والحسابات والمبيعات والمصروفات والخسائر / الأرباح."),
        ...
        "choseyourfeatureDesciption": MessageLookupByLibrary.simpleMessage(
            "الميزات هي الجزء الهام الذي يجعل DoSofto مختلفًا عن الحلول التقليدية."),
        ...
        "easytheusedesciption": MessageLookupByLibrary.simpleMessage(
            "تطبيق DoSofto مجاني وسهل الاستخدام. في الواقع، إنه واحد من أفضل أنظمة نقاط البيع حول العالم."),
