                ...
                Row(
                  children: [
                    ...
                    IconButton(
                        ...
                        icon: const Icon(Icons.close,color: kGreyTextColor,)),
                  ],
                ),
                SvgPicture.asset('assets/upgradePlan.svg',height: 198,width: 238,),
                const SizedBox(height: 20,),
                const Text('End your Free plan',style: TextStyle(fontSize: 24,fontWeight: FontWeight.w600,color: kTitleColor),),
                        ...
                        GestureDetector(
                          ...
                          child: Container(
                            decoration: BoxDecoration(
                              ...
                              boxShadow: [
                                BoxShadow(
                                  color: const Color(0xffC52127).withOpacity(0.04),
                                  blurRadius: 15,
                            ...
                            child: ListTile(
                              ...
                              leading: SvgPicture.asset('assets/plan.svg',height: 38,width: 38,),
                              ...
                              subtitle: Text('Update your subscription',style: gTextStyle.copyWith(color: kGreyTextColor,fontSize: 14),),
